    ...
    <body>        
        ...
        <div class="container">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <form method="post" action="DAO/DAOcadastra.jsp">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="../unidade/listaUnidade.jsp">Unidade</a>
                                                <input  name="codigounidade" value="escolha" disabled></input>
                                            ...
                                            <div class="form-group"> 
                                                <div class="container">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Vincular despesa</button>
            ...
            <div class="form-group">
                ...
                <a href="../despesa/listaDespesa.jsp">Despesa</a>
                <input  name="codigodespesa" value="<%=request.getParameter("codigodespesa")%>" placeholder="codigo" disabled></input>
